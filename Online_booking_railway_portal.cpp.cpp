...
n1* insert(queue<string>* source,queue<string>* dest,queue<string>* dep_time ,queue<string>* arrival_time,queue<int>* seats_ava,queue<int>* pnr_no,queue<string>* train_name,queue<string>* desc,queue<int>* price)
{
...
void update1(struct n1 * start,int p,int seat)
{
    while(start->dp!=NULL)
    {
        struct n2 *t=start->rp;
